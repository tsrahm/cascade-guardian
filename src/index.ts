...
export class CascadeGuardian {
   ...
   */
  async getCallers(functionName: string, filePath?: string): Promise<any> {
   ...
   */
  async getCallees(functionName: string, filePath?: string): Promise<any> {
   ...
   */
  async getImpact(functionName: string, filePath?: string, maxDepth?: number): Promise<any> {
   ...
   */
  async listTags(domain?: string, limit?: number): Promise<any> {
   ...
   */
  async listSystemLayers(): Promise<any> {
