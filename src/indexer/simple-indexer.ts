...
export async function buildSimpleIndex(projectPath?: string): Promise<void> {
...
async function insertFileRecords(db: any, files: string[], config: any): Promise<void> {
...
export async function extractBasicFunctions(filePath: string): Promise<any[]> {
...
function extractJSDoc(content: string, functionPosition: number): any {
